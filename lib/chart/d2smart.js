...
class D2Smart extends React.Component {
  ...
  render() {
    ...
    const ChartComponent = D2Smart.suggestChart(dataSet, dimensionAndMeasures);
    return (
...
D2Smart.propTypes = propTypes.rechartsWithData;

// register default rules
require('../rule/default')(D2Smart);
